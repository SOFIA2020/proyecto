...
import com.electroArreglos.service.TecnicoService;
...
public class TecnicoController {
    ...
    @PostMapping()
    public ServerResponseDataDto create(@RequestBody @Valid TecnicoDto dto) {

        TecnicoDto response = this.service.create(dto);
    ...
    public ServerResponseDataDto findAll() {
        ...
        List<TecnicoDto> dtos = this.service.findAll();
    ...
    public ServerResponseDataDto findById(@PathVariable("id") Long id) {
        ...
        TecnicoDto dto = this.service.getById(id);
    ...
    public ServerResponseDataDto updateById(
            ...
            @RequestBody @Valid TecnicoDto newData
    ) {

        TecnicoDto dto = this.service.updateById(id, newData);
